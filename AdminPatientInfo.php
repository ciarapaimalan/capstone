                            ...
                            <div class="form">
                                ...
                                <table>
                                    ...
                                    while ($row = mysqli_fetch_array($result)) {
                                        ...
                                        <br>
                                        <?php
                                        echo '<button onclick=location.href="AdminRiskAssessment.php?id=' . $row["ph_id"] . '">Start Risk Assessment</button>';
                                    }
                                    ?>
                    ...
                    <div class="container">
                        ...
                        <div class="tab-content ">
                            <div class="tab-pane active" id="1">
                                ...
                                $result = mysqli_query($mysqlconn, $sql);
                                while ($row = mysqli_fetch_array($result)) {
                                    echo '<br> <a href="AdminPatientInfoForm.php?id=' . $row['ph_id'] . '">Add New Record</a><br>';
                                }
                                ?>
                            ...
                            <div class="tab-pane" id="3">
                                ...
                                $result = mysqli_query($mysqlconn, $sql);
                                while ($row = mysqli_fetch_array($result)) {
                                    echo '<br> <a href="AdminSchedule.php?id=' . $row['ph_id'] . '">Schedule a Check-Up</a><br>';
                                }
                                ?>
