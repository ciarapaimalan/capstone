...
$sql = "INSERT INTO PatientInfo(pulmonary_diagnosis,oxygen_lvl,special_endorsement,physician,status,ward,bed_no,admission_no,hosp_no,admission_date,disposition,date)"
        . "values($address,$pulmonary_diagnosis,$other_diagnosis,$oxygen_lvl,$special_endorsement,$physician,$status,$ward,$bed_no,$admission_no,$hosp_no,$admission_date,$disposition,$date)";
