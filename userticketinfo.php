                ...
                <div>
                    ...
                    if (isSet($_POST['submit'])) {
                        ...
                        if ($mysqlconn->query($sqlcmd) === true) {
                            ...
                            <?php
                            echo "<script type='text/javascript'>window.top.location='UsersTickets.php';</script>";
                        } else {
                            ?>
                                            ...
                                            <div class="form-group">
                                                <div class="form-input">
                                                    ...
                                                    if ($row['status'] == 'Resolved') {
                                                        ...
                                                        ?><label for="status">Status</label>
                                                        <select id="disposition" name="status" class="form-control" >   
                                                            <option value="Processing" selected>Process</option>
                                                ...
                                                <input type="hidden" name="severity" class="id" required readonly value="<?php echo $row['severity']; ?>">

                                                <input type="hidden" name="adminusername" class="id" required readonly value="<?php echo $row['adminusername']; ?>">
                                                ...
                                                if ($row['status'] == 'Processing' || $row['status'] == 'Cancelled') {
                                                    ...
                                                    <div class="form-submit">
                                                        ...
                                                        <input type="button" value="Back" class="submit" id="back" name="back" onClick="window.location = 'UsersTickets.php'">
