...
<!--                        <input type="number" id="price" >-->
                                    ...
                                    <div class="container">
                                        <table class="table table-sm">
                                            ...
                                            <p id="regimendisplay" class="regimendisplay"></p>
                                    ...
                                    <div class="container">
                                        <table class="table table-sm">
                                            ...
                                            <td>Contraindication to anticoagulants?<br>          
                                                ...
                                                <input type="radio" name="anticoagulants" value="Yes" id="Yes"> Yes, elaborate <input type="text" id="elaborate" name="anticoagulants_elab"  style="border: none; border-bottom: 2px solid black; width: 70%;display:none;"><br>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><input type="checkbox" name="modalities[]"  id="others" onclick="ShowHideDiv(this)" />
                                                        ...
                                                        <div id="other_modalities" style="display: none">
                                                            <input type="text" id="other_modalities" name="other_modalities" style="border: none; border-bottom: 2px solid black; width: 100%;"/>
                                                        </div></td>
                                                </tr>
                                                <tr>
